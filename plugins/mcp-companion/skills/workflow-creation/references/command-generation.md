...
For each domain event, the command defines the set of arguments required to invoke the action on the aggregate. Think of each command as originating from a UX input form (wireframe-style) that the actor fills in and submits.
